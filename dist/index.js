...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["module", './presetRules'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, require('./presetRules'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, global.presetRules);
    global.undefined = mod.exports;
  }
})(void 0, function (module, defaultPresetRules) {
  "use strict";

  module.exports = class {
    constructor(presetRules) {
      let rules = Object.assign({}, defaultPresetRules, presetRules); // typeof presetRules should be object
    ...
    getVal(val, key) {
      if (key === '$') {
        ...
        for (let k of keys) {
          ...
          val = (_val = val) === null || _val === void 0 ? void 0 : _val[k];
        }
    ...
    checkOr(promises) {
      ...
      return invert(this.checkAnd(promises === null || promises === void 0 ? void 0 : promises.map(p => invert(p))));
    }
    ...
    pasreRule(rule) {
      ...
      if (rule) {
        ...
        if (typeof rule === 'string') {
          ...
          if (/\$$/.test(rule)) {
            parsedRule = {
              $or: ['null', rule.slice(0, -1)]
            };
          } // 处理array的情况
          else {
              var _$exec;

              let itemType = (_$exec = /^array\[(.+)\]\$?$/.exec(rule)) === null || _$exec === void 0 ? void 0 : _$exec[1];
